 ...
 *----------------------------------------------------------------------------
 *      Name:    NAND_SAM3U.h 
 *      Purpose: NAND Flash Interface Driver for Atmel ATSAM3U Defs
 *      Rev.:    V4.20
 *----------------------------------------------------------------------------
...
#ifndef __NAND_SAM3U_H_
#define __NAND_SAM3U_H_

/*----------------------------------------------------------------------------
 *      SAM3U Peripheral Write Protection Keys
 *---------------------------------------------------------------------------*/
...
/* Chip select */
#define SAM3U_NAND_CS0      0x00
#define SAM3U_NAND_CS1      0x01
#define SAM3U_NAND_CS2      0x02
#define SAM3U_NAND_CS3      0x03
